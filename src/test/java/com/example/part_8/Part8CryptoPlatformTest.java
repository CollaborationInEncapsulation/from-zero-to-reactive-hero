 ...
 */
public class Part8CryptoPlatformTest {

    @Test
    public void verifyIncomingMessageValidation() {
        StepVerifier.create(
                Part8CryptoPlatform.handleRequestedAveragePriceIntervalValue(
    ...
    public void verifyOutgoingStreamBackpressure() {
        ...
        StepVerifier
                .create(
                        Part8CryptoPlatform.handleOutgoingStreamBackpressure(processor),
                        0
                )
                .expectSubscription()
